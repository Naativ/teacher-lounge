...
<div class="eg-slideshow">
  <slide v-for="slide in currSlides" :key="slide.id">
    <eg-transition v-for="asset in slide.assets" :key="asset.id">
      <img :src="asset.url"/>
    </eg-transition>
  </slide>
  <div style="visibility: hidden; width: 0px; heigth: 0px">
    <template v-for="slide in currSlides">
      <img v-for="asset in slide.assets" :key="asset.id" :src="asset.url"/>
    </template>
  </div>
</div>
</template>
