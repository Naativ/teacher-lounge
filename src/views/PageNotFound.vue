<template>
  <v-flex xs12>
    <div>
      ...
      <div>
        <v-card class="pa-2 error-card">
          <v-form>
            <v-card-text class="centered white">
              <h3>You Have Left School Grounds</h3>
              <h3>Error 404: This Page Cannot Be Found</h3>
            </v-card-text>
            <div class="centered">
              <router-link to="/lounge/dashboard">
                <v-btn
                  color="#00d3e6"
                  depressed
                  round
